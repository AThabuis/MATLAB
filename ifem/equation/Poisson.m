...
%
%   The function Poisson assembles the matrix equation AD*u = b and solves
...
switch solver
    ...
    case 'mg'
        if ~isfield(option,'mgoption')   % no option.mgoption
            ...
            option.mgoption.printlevel = option.printlevel; % Added afterwards !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        end
    ...
    case 'amg'
        if ~isfield(option,'amgoption')  % no option.amgoption
            ...
            option.amgoption.printlevel = option.printlevel; % Added afterwards !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        end
